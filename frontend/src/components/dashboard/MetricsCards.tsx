...
const getIconForMetric = (iconName: string) => {
  const iconMap: { [key: string]: JSX.Element } = {
    ...
    people: (
      ...
      >
        ...
        <path
          d="M18 21C21.866 21 25 23.2386 25 26C25 27.1046 24.1046 28 23 28H13C11.8954 28 11 27.1046 11 26C11 23.2386 14.134 21 18 21ZM18 12C20.2091 12 22 13.7909 22 16C22 18.2091 20.2091 20 18 20C15.7909 20 14 18.2091 14 16C14 13.7909 15.7909 12 18 12ZM26 14C26.5523 14 27 14.4477 27 15V16H28C28.5523 16 29 16.4477 29 17C29 17.5523 28.5523 18 28 18H27V19C27 19.5523 26.5523 20 26 20C25.4477 20 25 19.5523 25 19V18H24C23.4477 18 23 17.5523 23 17C23 16.4477 23.4477 16 24 16H25V15C25 14.4477 25.4477 14 26 14Z"
          fill="white"
        />
      </svg>
    ),
  ...
  return iconMap[iconName] || iconMap["trending_up"];
};
  ...
  if (isLoading) {
    return (
      <Box sx={{ 
        ...
        <LoadingSpinner message="Loading metrics..." fullHeight />
      </Box>
    );
  }
  ...
  if (!metrics || metrics.length === 0) {
    return (
      <Box sx={{ 
        ...
        <ErrorDisplay message="No metrics data available" fullHeight showRetry={false} />
      </Box>
    );
  }
    ...
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        {metrics.map((metric, index) => {
          // Convert API color to background color (lighten it)
          const bgColor = metric.color ? `${metric.color}20` : '#F8F9FA';
          const iconColor = metric.color || '#4079ED';
